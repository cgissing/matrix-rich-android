...
**Files:**
- Create: `app/src/test/java/xyz/luoyu/matrixrich/NtfyMessageTest.java`
- Create: `app/src/test/java/xyz/luoyu/matrixrich/NtfyEndpointTest.java`
- Create: `app/src/main/java/xyz/luoyu/matrixrich/NtfyMessage.java`
- Create: `app/src/main/java/xyz/luoyu/matrixrich/NtfyEndpoint.java`
...
- Create: `app/src/main/java/xyz/luoyu/matrixrich/MainActivity.java`
...
**Files:**
- Create: `app/src/main/java/xyz/luoyu/matrixrich/MobileElementAdapter.java`
- Create: `app/src/test/java/xyz/luoyu/matrixrich/MobileElementAdapterTest.java`
- Modify: `app/src/main/java/xyz/luoyu/matrixrich/MainActivity.java`
...
**Files:**
- Create: `app/src/main/java/xyz/luoyu/matrixrich/NtfyPushService.java`
- Create: `app/src/main/java/xyz/luoyu/matrixrich/BootReceiver.java`
